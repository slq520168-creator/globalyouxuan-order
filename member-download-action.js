(()=>{
  ...
  function opportunityTitle(r){const key='communityOpportunity.'+String(r?.opportunity_id||'')+'.title',value=I.t(key);return value===key?I.t('communityOpportunityFallback'):value}
