(() => {
  ...
  const messages = {
    'zh-CN': {
      ...
      heroLineOne: '连接全球智慧', heroLineTwo: '驱动数字', heroLineAccent: '未来',
      shopEyebrow: '', shopTitle: '连接全球智慧，驱动数字未来',
      shopLead: '助力企业与个人实现数字化升级',
      ...
      goMemberOrders: '查看我的订单', close: '关闭', musicOn: '♫ 正在播放', musicOff: '♫ 播放音乐', musicError: '音乐未能播放，请关闭手机静音后再点一次。',
      authTitle: '会员注册与登录', authLead: '一个账号，保存你的方案、收藏与订单。',
      loginTab: '登录', registerTab: '注册', displayName: '会员名称', displayNamePlaceholder: '请输入会员名称',
      password: '密码', passwordPlaceholder: '8～10位数字加字母', confirmPassword: '确认密码',
      confirmPasswordPlaceholder: '再次输入8～10位数字加字母', signIn: '登录会员账号', signingIn: '正在登录…',
      ...
      forgotPassword: '忘记密码？', backToLogin: '返回登录', sendResetLink: '发送重置邮件', sendingResetLink: '正在发送…',
      resetEmailSent: '重置邮件已发送，请打开邮件中的链接设置新密码。', resetPasswordTitle: '设置新密码',
      resetPasswordLead: '验证链接通过后，在这里设置新密码。', newPassword: '新密码', confirmNewPassword: '确认新密码',
      checkingResetLink: '正在验证重置链接…', resetLinkReady: '验证成功，请设置新密码。', resetLinkInvalid: '重置链接无效或已过期，请重新发送。',
      saveNewPassword: '保存新密码', savingNewPassword: '正在保存…', passwordResetSuccess: '密码修改成功，正在返回登录。', requestNewResetLink: '重新发送重置邮件',
    ...
    en: {
      ...
      heroLineOne: 'Connect Global Intelligence', heroLineTwo: 'Drive the Digital', heroLineAccent: 'Future',
      shopEyebrow: '', shopTitle: 'Connect global intelligence and drive the digital future',
      shopLead: 'Helping people and businesses move forward digitally',
      ...
      quickSearchPlaceholder: 'AI search for practical solutions…', search: 'Search',
      ...
      moduleWebsite: 'Website Building', moduleWebsiteLead: 'Sites, stores and member systems', moduleAi: 'Smart Future', moduleAiLead: 'AI creation and assistants',
      ...
      fixedPlansLabel: 'Fixed plans', fixedStartsAt: 'From {price} USDT',
      ...
      close: 'Close', musicOn: '♫ Playing', musicOff: '♫ Play music', musicError: 'Music could not play. Turn off silent mode and tap again.',
      ...
      password: 'Password', passwordPlaceholder: '8-10 letters and numbers', confirmPassword: 'Confirm password',
      ...
      forgotPassword: 'Forgot password?', backToLogin: 'Back to sign in', sendResetLink: 'Send reset email', sendingResetLink: 'Sending…',
      resetEmailSent: 'The reset email was sent. Open its link to choose a new password.', resetPasswordTitle: 'Set a new password',
      resetPasswordLead: 'After the link is verified, choose your new password here.', newPassword: 'New password', confirmNewPassword: 'Confirm new password',
      checkingResetLink: 'Verifying the reset link…', resetLinkReady: 'Verified. Choose a new password.', resetLinkInvalid: 'This reset link is invalid or expired. Send a new one.',
      saveNewPassword: 'Save new password', savingNewPassword: 'Saving…', passwordResetSuccess: 'Password changed. Returning to sign in.', requestNewResetLink: 'Send another reset email',
    ...
    km: {
      ...
      heroLineOne: 'ភ្ជាប់បញ្ញាសកល', heroLineTwo: 'ជំរុញអនាគត', heroLineAccent: 'ឌីជីថល',
      shopEyebrow: '', shopTitle: 'ភ្ជាប់បញ្ញាសកល និងជំរុញអនាគតឌីជីថល',
      shopLead: 'ជួយអាជីវកម្ម និងបុគ្គលឱ្យរីកចម្រើនតាមឌីជីថល',
      ...
      quickSearchPlaceholder: 'ស្វែងរកដំណោះស្រាយជាមួយ AI…', search: 'ស្វែងរក',
      ...
      fixedPlansLabel: 'គម្រោងថេរ', fixedStartsAt: 'ចាប់ពី {price} USDT',
      ...
      close: 'បិទ', musicOn: '♫ កំពុងលេង', musicOff: '♫ ចាក់តន្ត្រី', musicError: 'មិនអាចចាក់តន្ត្រីបានទេ។ សូមបិទរបៀបស្ងាត់ ហើយចុចម្តងទៀត។',
      ...
      forgotPassword: 'ភ្លេចពាក្យសម្ងាត់?', backToLogin: 'ត្រឡប់ទៅចូល', sendResetLink: 'ផ្ញើអ៊ីមែលកំណត់ឡើងវិញ', sendingResetLink: 'កំពុងផ្ញើ…',
      resetEmailSent: 'បានផ្ញើអ៊ីមែលកំណត់ឡើងវិញ។ សូមបើកតំណក្នុងអ៊ីមែល។', resetPasswordTitle: 'កំណត់ពាក្យសម្ងាត់ថ្មី',
      resetPasswordLead: 'បន្ទាប់ពីផ្ទៀងផ្ទាត់តំណ សូមកំណត់ពាក្យសម្ងាត់ថ្មីនៅទីនេះ។', newPassword: 'ពាក្យសម្ងាត់ថ្មី', confirmNewPassword: 'បញ្ជាក់ពាក្យសម្ងាត់ថ្មី',
      checkingResetLink: 'កំពុងផ្ទៀងផ្ទាត់តំណ…', resetLinkReady: 'ផ្ទៀងផ្ទាត់បានជោគជ័យ។ សូមកំណត់ពាក្យសម្ងាត់ថ្មី។', resetLinkInvalid: 'តំណមិនត្រឹមត្រូវ ឬផុតកំណត់។ សូមផ្ញើម្តងទៀត។',
      saveNewPassword: 'រក្សាទុកពាក្យសម្ងាត់ថ្មី', savingNewPassword: 'កំពុងរក្សាទុក…', passwordResetSuccess: 'បានប្តូរពាក្យសម្ងាត់។ កំពុងត្រឡប់ទៅចូល។', requestNewResetLink: 'ផ្ញើអ៊ីមែលម្តងទៀត',
