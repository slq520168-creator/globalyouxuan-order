...
.fixed-module-section.module-options-open>.module-grid{display:none!important}
.fixed-module-section.module-options-open>.fixed-plans-panel{position:relative!important;z-index:12!important;margin:0!important;display:flex!important;flex-direction:column!important;padding:12px!important;box-sizing:border-box!important;border:0!important;border-radius:20px!important;background:transparent!important;box-shadow:none!important;overflow:visible!important;animation:gyxOptionsWrapIn .18s ease both}
...
.fixed-module-section .fixed-plan{min-height:0!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;opacity:0;transform:translateY(14px) scale(.96);animation:gyxOptionPop .28s cubic-bezier(.2,.8,.2,1) forwards}
.fixed-module-section .fixed-plan:nth-child(1){animation-delay:.03s}.fixed-module-section .fixed-plan:nth-child(2){animation-delay:.09s}.fixed-module-section .fixed-plan:nth-child(3){animation-delay:.15s}.fixed-module-section .fixed-plan:nth-child(4){animation-delay:.21s}
...
.fixed-module-section .fixed-plan-option:active{transform:scale(.96)}
...
@keyframes gyxOptionsWrapIn{from{opacity:.6;transform:scale(.985)}to{opacity:1;transform:none}}
@keyframes gyxOptionPop{0%{opacity:0;transform:translateY(14px) scale(.96)}70%{opacity:1;transform:translateY(-2px) scale(1.015)}100%{opacity:1;transform:none}}
