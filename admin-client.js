(() => {
  ...
  const go=()=>{load("admin-advanced.js?v=20260810-full-control-1","gyx-advanced");load("admin-data.js?v=20260810-data-control-1","gyx-data");load("admin-code-file.js?v=20260810-code-upload-1","gyx-codefile");load("admin-member-level.js?v=20260811-levels-1","gyx-memberlevel");load("admin-member-profile.js?v=20260813-profile-edit-fixed-1","gyx-memberprofile");load("admin-profile-requests.js?v=20260811-profile-review-1","gyx-profilerequests");load("admin-member-security.js?v=20260813-mobile-scroll-fix-1","gyx-membersecurity")};
